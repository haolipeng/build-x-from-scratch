...
func (t Token) String() string {
	...
	case TokenCharGroup:
		if t.CharGroup.Negated {
			return fmt.Sprintf("NegCharGroup(%v, %v)", t.CharGroup.Chars, t.CharGroup.Ranges)
		}
		return fmt.Sprintf("CharGroup(%v, %v)", t.CharGroup.Chars, t.CharGroup.Ranges)
	default:
		return "Unknown"
	}
}
