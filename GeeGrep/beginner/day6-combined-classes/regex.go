...
func (t Token) String() string {
	...
	case TokenCharGroup:
		if t.CharGroup.Negated {
			return fmt.Sprintf("NegCharGroup(chars=%v, ranges=%v, classes=%v)",
				t.CharGroup.Chars, t.CharGroup.Ranges, t.CharGroup.CharClasses)
		}
		return fmt.Sprintf("CharGroup(chars=%v, ranges=%v, classes=%v)",
			t.CharGroup.Chars, t.CharGroup.Ranges, t.CharGroup.CharClasses)
	default:
		return "Unknown"
	}
